...
public class Pub extends JPanel implements KeyListener{
	...
	public Pub(JFrame start,int girlnumber) {
		this.start = start;
		rub = this;
...
//				PubBack.setBounds(0, 0, 960, 720);
		...
		if(Main.day == 0) {
			icon1 = new JLabel(new ImageIcon("images/pub1.png"));
	    icon1.setBounds(0, 0, 960, 720);
	    this.add(icon1);
		}else if(Main.day == 1) {
			icon1 = new JLabel(new ImageIcon("images/pub2.png"));
		    icon1.setBounds(0, 0, 960, 720);
		    this.add(icon1);
		}else if(Main.day == 2) {
			icon1 = new JLabel(new ImageIcon("images/pub3.png"));
		    icon1.setBounds(0, 0, 960, 720);
		    this.add(icon1);
		}
